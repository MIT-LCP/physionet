...
class ValidationResult:
    ...
    def summary(self) -> str:
        ...
        # Add footer with package information
        lines.extend([
            "",
            "=" * 50,
            "This report was generated by the PhysioNet Python package.",
            "Install: pip install physionet",
            "Learn more: https://github.com/MIT-LCP/physionet",
        ])
